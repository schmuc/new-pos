    ...
    <section class="min-height-full">
        <header>
            <ul class="flex justify-end">
                ...
                <li class="m-8"><a class="uppercase text-lg" href="../employee/employee-login.php">employee</a></li>
            </ul>
        </header>
        <form class="container border-show rounded-xl mx-auto w-2/5" method="post" action="admin-validate.php">
            <div class="uppercase text-center text-lg py-4 font-black link">admin login</div>
            <div class="flex flex-col items-center">
                <div class=" mt-8 w-4/5">
                    <div class="flex rounded-lg p-4 mt-4 border-show bg-white">
                        <img class="w-4" src="../img/icon/admin.svg" alt="No image">
                ...
                <div class=" my-16">
                    <input class="button1 rounded-lg w-28 py-1 font-extrabold" type="submit" value="Sign In" name="admin-login-submit">
                </div>
            </div>
        </form>
    </section>
