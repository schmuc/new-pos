...
<?php
   include '../sql/queries.php';
    ...
    if(isset($_POST['admin-mypassword-submit'])){
        ...
        if($newPassword == $retypeNewPassword){
            if($oldPassword == $account['password']){
                $admin->adminUpdatePassword($account['admin_id'], $newPassword);
        ...
        ?>
         <div class="w-full flex justify-center">
            <form class="container border-show rounded-lg p-4 m-20 flex flex-col items-center w-2/5" method="post">
                ...
                <input class="button1 border-show w-28 rounded-lg py-1 mt-10" type="submit" value="Update" name="admin-mypassword-submit">
                <a class="mt-4 underline capitalize" href="admin-my-account.php">my profile</a>
            </form>
        </div>
    </section>
