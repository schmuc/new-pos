...
<?php
    ...
    $staff->employeeSetActive($account['employee_id']);
?>
<body>
    <section class="min-height-full relative">
        <?php require('employee-header.php'); ?>
        <div>
            <div class="w-3/4 pt-20 p-4 absolute right-0 top-0">
                <div>
                ...
                <div class="mt-4 flex flex-wrap">
                    <?php
                        ...
                        foreach($products as $product){
                            echo "<div class='border-show w-fit relative m-4 product-container' onclick='previewProduct(this);' style='width: 30%; height: 12em;' data-stock='$product[stock]' data-id='$product[product_id]' data-cost='$product[cost]' data-name='$product[product]' data-size='$product[size]' data-quantity=1 data-amount='$product[price]'>";
        ...
        <div class="order-container-2">
            <div class="flex flex-col items-center">
                ...
                <div class="w-full flex items-center mt-4">
                    ...
                    <input class="button3 px-4 ml-4 add-button font-semibold" type="button" value="ADD" onclick="addOrder(this, 'employee')">
                </div>
            </div>
            <div class="h-1/2">
                <form class="px-4 h-full flex flex-col justify-evenly items-center" method="post" action="employee-add-order.php" onsubmit="submitOrder(event)">
                    ...
                    <div class="flex justify-between w-full">
                        ...
                        <input class="button3 w-2/5 rounded-lg py-1" type="submit" value="PLACE ORDER" name="employee-order-submit">
                    </div>
                </form>
            </div>
        </div>
